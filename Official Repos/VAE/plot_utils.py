...
class Plot_Reproduce_Performance():
    ...
    def save_images(self, images, name='result.jpg'):
        ...
        save_img(self.DIR + "/"+name, self._merge(images, [self.n_img_y, self.n_img_x]))
    ...
    def _merge(self, images, size):
        ...
        for idx, image in enumerate(images):
            ...
            image_ = np.array(Image.fromarray(obj=image, mode='F').resize(size=(w_,h_), resample=Image.BICUBIC))
